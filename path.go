...
type PathParts struct {
	...
	ExtBase  string `json:"ext_base,omitempty"`  // Base Extension, furthest to the right.  E.g. `.js`
...
// Populated returns a populated PathParts struct.
